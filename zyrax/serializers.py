...
from .models import Banner, Offer,Zyrax_Class, UserProfile , CommunityPost, PostImage, Comment, Service_Post
...
# Service Post
class Service_PostSerializer(serializers.ModelSerializer):
    class Meta:
        model = Service_Post
        fields = ['id', 'title', 'image', 'description']